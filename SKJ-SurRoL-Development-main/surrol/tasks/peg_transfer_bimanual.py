...
from surrol.tasks.psm_env_rpy import PsmsEnv, goal_distance
...
class BiPegTransfer(PsmsEnv):
    ...
    def _sample_goal_callback(self):
        ...
        self._waypoints.append(np.array([pos_place[0], pos_place[1], pos_place[2]-0.08, roll1, pitch1,yaw1, -0.5,
                                         pos_mid2[0], pos_mid2[1], pos_mid2[2] + 0.01 * self.SCALING,roll2, pitch2,
                                         yaw2, 0.5]))  # release to goal
        self._waypoints.append(np.array([pos_place[0], pos_place[1], pos_place[2]-0.08, roll1, pitch1,yaw1, 0.5,
                                         pos_mid2[0], pos_mid2[1], pos_mid2[2] + 0.01 * self.SCALING,roll2, pitch2,
