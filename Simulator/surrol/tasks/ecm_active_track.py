...
from Simulator.surrol.utils.utils import RGB_COLOR_255, Boundary, Trajectory, get_centroid
...
class ActiveTrack(EcmEnv):
    ...
    def _get_obs(self) -> np.ndarray:
        ...
        plt.imsave('/home/kejianshi/Desktop/Surgical_Robot/Surrol_Related/SKJ-SurRoL-Development/surrol/data/rgb_array1.png', rgb1)
        if self.STEREO:
            rgb2 = output.rgb2
            plt.imsave('/home/kejianshi/Desktop/Surgical_Robot/Surrol_Related/SKJ-SurRoL-Development/surrol/data/rgb_array2.png', rgb2)
