...
from Simulator.surrol.tasks.psm_env import PsmEnv, goal_distance
...
#       self._pegs[0]: 2
    ...
    def _sample_goal_callback(self):
        ...
        self._waypoints[1] = np.array([pos_obj[0]-0.03, pos_obj[1],
                                       pos_obj[2] + (0.003 + 0.01) * self.SCALING, yaw, 0.5])  # approach
        self._waypoints[2] = np.array([pos_obj[0]-0.03, pos_obj[1],
                                       pos_obj[2] + (0.003 + 0.01) * self.SCALING, yaw, -0.5])  # grasp
        ...
        self._waypoints[4] = np.array([pos_place[0]-0.02, pos_place[1]+0.00, pos_place[2], yaw, -0.5])  # above goal
        self._waypoints[5] = np.array([pos_place[0]-0.02, pos_place[1]+0.00, pos_place[2]-0.02, yaw, -0.5])  # release
        self._waypoints[6] = np.array([pos_place[0]-0.02, pos_place[1]+0.00, pos_place[2]-0.02, yaw, 0.5])  # release
